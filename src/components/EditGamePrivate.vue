<template>
    <div>
        ...
        <div class="game-inner" v-show="tabShowStatus[index].child.option">
            <!--checkbox-->
             <el-checkbox style="width:100%;" v-model="testData.checked" size="small">checkbox</el-checkbox>
             <!--switch 开关-->
            <div class="edit-switch" style="margin-left:-38px;">
                <span>Switch</span>
                <el-switch
                        v-model="testData.switch"
                        active-color="#77DC04"
            ...
            <div style="width:100%;float:left;">
                <el-input style="width:50%;" placeholder="请输入内容" v-model="testData.input" size="mini">
             ...
             <div class="edit-select" style="width: 100%">
                ...
                <el-select v-model="testData.select" placeholder="请选择" size="mini" style="width: 60%">
                    <el-option
                           v-for="item in testData.fontSize"
                            :key="item.value"
                            :label="item.label"
                            :value="item.value">
                    </el-option>
            ...
            <div class="upload">
                <div class="img-box">
                    <img  alt="" width="131" height="96">
                </div>
                <div class="upload-btn">
                    <div class="upload-btn-file">
                        <span>更改图片</span>
                        <input type="file" @change="uploadImage(index,'answer',$event)">
                    </div>
                </div>
            </div>
            <!--精灵序列图-->
            <div class="upload">
                ...
                <div class="animate-box">
                    <span v-text="testData.spriteName"></span>
                </div>
                <div class="upload-btn">
                    <div class="upload-btn-file">
                        <span>更改文件</span>
            ...
            <div class="upload">
                ...
                <div class="animate-box">
                    <span v-text="testData.animateName"></span>
                </div>
                <div class="upload-btn">
                    <div class="upload-btn-file">
                        <span>更改文件</span>
                        <input type="file" multiple="multiple"
                               @change="uploadAnimation($event)">
                    </div>
                </div>
            </div>
             <!--音频上传-->
             <div class="upload">
                <span class="file-title">音频文件</span>
                    <div class="animate-box">
                        <span v-text="testData.audioName"></span>
                    </div>
                    <div class="upload-btn">
                        <div class="upload-btn-file">
                            <span>更改文件</span>
                            <input type="file" multiple="multiple" @change="uploadAudio(index,'answer',$event)">
                        </div>
                    </div>
            </div>
            <!--radio-->
            <div class="edit-radio-title">
                <el-radio v-model="label" label="1">图片</el-radio>
                <el-radio v-model="label" label="2" >动画</el-radio>
            </div>
        </div>
    </div>
</template>
