<template>
    <div class="container">
        <canvas id="success-canvas" width="1920" height="1080" style="width: 19.2rem;height: 10.8rem;position: absolute;z-index:10000;display: none"></canvas>
...
<script>
    ...
    import {Bag} from '../components/ui/Bag.js';
    import endAn from '../components/ui/endAn.js';
